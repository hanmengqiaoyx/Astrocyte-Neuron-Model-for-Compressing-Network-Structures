...
def model_prepare(work):
    ...
    scheduler0 = torch.optim.lr_scheduler.MultiStepLR(optimizer0, milestones=[100, 150, 200], gamma=0.1, last_epoch=-1)
    scheduler1 = torch.optim.lr_scheduler.MultiStepLR(optimizer1, milestones=[100, 150, 200], gamma=0.1, last_epoch=-1)
