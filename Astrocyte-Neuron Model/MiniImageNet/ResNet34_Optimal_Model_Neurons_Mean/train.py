...
parser.add_argument('--lr0', default=2e-1, type=float, help='learning rate0')
parser.add_argument('--lr1', default=2e-1, type=float, help='learning rate1')
...
# Data
def data_prepare():
    trainloader = DataLoader(torch.load('../MiniImageNet_Train.t7'), batch_size=64, shuffle=True)
    testloader = DataLoader(torch.load('../MiniImageNet_Test.t7'), batch_size=64, shuffle=True)
...
def train(epoch, dataloader, net, optimizer0, criterion0, optimizer1, criterion1, vali=True):
    ...
    for batch_id, (inputs, targets) in enumerate(dataloader):
        ...
        outputs, c_gate0, c_gate1, c_gate2, c_gate3, c_gate4, c_gate5, c_gate6, c_gate7, c_gate8, c_gate9, \
        c_gate10, c_gate11, c_gate12, c_gate13, c_gate14, c_gate15, c_gate16, c_gate17, c_gate18, c_gate19, \
        c_gate20, c_gate21, c_gate22, c_gate23, c_gate24, c_gate25, c_gate26, c_gate27, c_gate28, c_gate29, \
        c_gate30, c_gate31, c_gate32, f_gate33 = net(inputs, epoch)
        if epoch % 2 == 0:
            num_id0 += 1
