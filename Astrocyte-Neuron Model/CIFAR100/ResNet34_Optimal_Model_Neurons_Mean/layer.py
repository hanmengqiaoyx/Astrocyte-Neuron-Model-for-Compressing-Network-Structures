    ...
    def forward(self, input, epoch):
        if self.training:
            if epoch >= 4 and epoch % 2 == 0:
                ...
                layer40 = F.relu(self.dw_bn4(nn.functional.conv2d(layer31, self.dw_weights4, stride=1, padding=1, bias=None)))  # [1, 128, 8, 4]
                ...
                layer_out = F.relu(self.gate_bn0(nn.functional.conv2d(layer92, self.gate_weights0, stride=1, padding=1, bias=None)))  # [1, 1, 133, 64]
...
class Convolution18(nn.Module):
    def __init__(self, in_features, out_features):
        ...
        :param bias: Whether we use a bias
        """
        super(Convolution18, self).__init__()
        self.in_features = in_features
        self.out_features = out_features
        self.weights = Parameter(torch.Tensor(out_features, in_features, 3, 3))
        self.bn = nn.BatchNorm2d(out_features)
...
class Convolution19(nn.Module):
    def __init__(self, in_features, out_features):
        ...
        :param bias: Whether we use a bias
        """
        super(Convolution19, self).__init__()
        self.in_features = in_features
        self.out_features = out_features
        self.weights = Parameter(torch.Tensor(out_features, in_features, 3, 3))
        self.bn = nn.BatchNorm2d(out_features)
...
class Convolution20(nn.Module):
    def __init__(self, in_features, out_features):
        ...
        :param bias: Whether we use a bias
        """
        super(Convolution20, self).__init__()
        self.in_features = in_features
        self.out_features = out_features
        self.weights = Parameter(torch.Tensor(out_features, in_features, 3, 3))
        self.bn = nn.BatchNorm2d(out_features)
...
class Convolution21(nn.Module):
    def __init__(self, in_features, out_features):
        ...
        :param bias: Whether we use a bias
        """
        super(Convolution21, self).__init__()
        self.in_features = in_features
        self.out_features = out_features
        self.weights = Parameter(torch.Tensor(out_features, in_features, 3, 3))
        self.bn = nn.BatchNorm2d(out_features)
...
class Convolution22(nn.Module):
    def __init__(self, in_features, out_features):
        ...
        :param bias: Whether we use a bias
        """
        super(Convolution22, self).__init__()
        self.in_features = in_features
        self.out_features = out_features
        self.weights = Parameter(torch.Tensor(out_features, in_features, 3, 3))
        self.bn = nn.BatchNorm2d(out_features)
...
class Convolution23(nn.Module):
    def __init__(self, in_features, out_features):
        ...
        :param bias: Whether we use a bias
        """
        super(Convolution23, self).__init__()
        self.in_features = in_features
        self.out_features = out_features
        self.weights = Parameter(torch.Tensor(out_features, in_features, 3, 3))
        self.bn = nn.BatchNorm2d(out_features)
...
class Convolution24(nn.Module):
    def __init__(self, in_features, out_features):
        ...
        :param bias: Whether we use a bias
        """
        super(Convolution24, self).__init__()
        self.in_features = in_features
        self.out_features = out_features
        self.weights = Parameter(torch.Tensor(out_features, in_features, 3, 3))
        self.bn = nn.BatchNorm2d(out_features)
...
class Convolution25(nn.Module):
    def __init__(self, in_features, out_features):
        ...
        :param bias: Whether we use a bias
        """
        super(Convolution25, self).__init__()
        self.in_features = in_features
        self.out_features = out_features
        self.weights = Parameter(torch.Tensor(out_features, in_features, 3, 3))
        self.bn = nn.BatchNorm2d(out_features)
...
class Convolution26(nn.Module):
    def __init__(self, in_features, out_features):
        ...
        :param bias: Whether we use a bias
        """
        super(Convolution26, self).__init__()
        self.in_features = in_features
        self.out_features = out_features
        self.weights = Parameter(torch.Tensor(out_features, in_features, 3, 3))
        self.bn = nn.BatchNorm2d(out_features)
...
class Convolution27(nn.Module):
    def __init__(self, in_features, out_features):
        ...
        :param bias: Whether we use a bias
        """
        super(Convolution27, self).__init__()
        self.in_features = in_features
        self.out_features = out_features
        self.weights = Parameter(torch.Tensor(out_features, in_features, 3, 3))
        self.bn = nn.BatchNorm2d(out_features)
...
class Convolution28(nn.Module):
    def __init__(self, in_features, out_features):
        ...
        :param bias: Whether we use a bias
        """
        super(Convolution28, self).__init__()
        self.in_features = in_features
        self.out_features = out_features
        self.weights = Parameter(torch.Tensor(out_features, in_features, 3, 3))
        self.bn = nn.BatchNorm2d(out_features)
...
class Convolution29(nn.Module):
    def __init__(self, in_features, out_features):
        ...
        :param bias: Whether we use a bias
        """
        super(Convolution29, self).__init__()
        self.in_features = in_features
        self.out_features = out_features
        self.weights = Parameter(torch.Tensor(out_features, in_features, 3, 3))
        self.bn = nn.BatchNorm2d(out_features)
...
class Convolution30(nn.Module):
    def __init__(self, in_features, out_features):
        ...
        :param bias: Whether we use a bias
        """
        super(Convolution30, self).__init__()
        self.in_features = in_features
        self.out_features = out_features
        self.weights = Parameter(torch.Tensor(out_features, in_features, 3, 3))
        self.bn = nn.BatchNorm2d(out_features)
...
class Convolution31(nn.Module):
    def __init__(self, in_features, out_features):
        ...
        :param bias: Whether we use a bias
        """
        super(Convolution31, self).__init__()
        self.in_features = in_features
        self.out_features = out_features
        self.weights = Parameter(torch.Tensor(out_features, in_features, 3, 3))
        self.bn = nn.BatchNorm2d(out_features)
...
class Convolution32(nn.Module):
    def __init__(self, in_features, out_features):
        ...
        :param bias: Whether we use a bias
        """
        super(Convolution32, self).__init__()
        self.in_features = in_features
        self.out_features = out_features
        self.weights = Parameter(torch.Tensor(out_features, in_features, 3, 3))
        self.bn = nn.BatchNorm2d(out_features)
