...
def train(epoch, dataloader, net, optimizer0, criterion0, optimizer1, criterion1, vali=True):
    ...
    for batch_id, (inputs, targets) in enumerate(dataloader):
        ...
        outputs, c_gate1, c_gate2, c_gate3, c_gate4, c_gate5, c_gate6, c_gate7, c_gate8, c_gate9, \
        c_gate10, c_gate11, c_gate12, c_gate13, c_gate14, c_gate15, c_gate16, c_gate17, f_gate18 = net(inputs, epoch)
        if epoch % 2 == 0:
            num_id0 += 1
