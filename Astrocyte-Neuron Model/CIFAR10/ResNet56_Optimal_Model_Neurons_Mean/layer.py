    ...
    def forward(self, input, epoch):
        if self.training:
            if epoch >= 2 and epoch % 2 == 0:
                ...
                layer40 = F.relu(self.dw_bn4(nn.functional.conv2d(layer31, self.dw_weights4, stride=1, padding=1, bias=None)))  # [1, 128, 4, 2]
                ...
                layer_out = F.relu(self.row_bn1(nn.functional.conv2d(layer11, self.row_weights1, stride=1, bias=None)))  # [1, 1, 64, 1]
